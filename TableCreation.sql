...
CREATE TABLE ENROLLMENT (
    ...
    CONSTRAINT CHK_EnrollmentStatus CHECK (EnrollmentStatus IN ('Active', 'Completed', 'Dropped'))
);
...
CREATE TABLE COURSE_ASSIGNMENT (
    ...
    CONSTRAINT FK_CA_COURSE FOREIGN KEY (CourseID)
        REFERENCES COURSE(CourseID),
    CONSTRAINT FK_CA_FACULTY FOREIGN KEY (FacultyID)
