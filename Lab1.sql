...
INSERT INTO STUDENT
    (StudentID, StuName, StuEmail, StuPhone, StuDepartment, StuDateOfBirth, StuEnrollmentYear)
VALUES
    (9, 'Neha Singh', 'neha.singh@univ.edu', '9876543218', 'IT', '2003-09-20', 2021);
...
SELECT CourseDepartment, COUNT(CourseID) AS TotalCourses
FROM COURSE
...
SELECT EnrollmentStatus, COUNT(EnrollmentID) AS TotalEnrollments
FROM ENROLLMENT
